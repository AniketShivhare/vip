class OrderSummaryMonthly {
  ...
  factory OrderSummaryMonthly.fromJson(Map<String, dynamic> json) {
    return OrderSummaryMonthly(
      todaysOrder: (json['currentMonthOrder'] as List<dynamic>?)
          ?.map((order) => OrderDetail.fromJson(order))
          .toList() ?? [],
      yesterdayOrders: (json['prevMonthOrders'] as List<dynamic>?)
          ?.map((order) => OrderDetail.fromJson(order))
          .toList() ?? [],
