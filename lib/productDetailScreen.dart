...
//     currentIndex = widget.imageUrls.indexOf(widget.selectedImageUrl);
//     _pageController = PageController(initialPage: currentIndex);
//     _scrollController = ScrollController(initialScrollOffset: currentIndex * 85.0);
//     _pageController.addListener(_pageControllerListener);
//   }
//
//   void _pageControllerListener() {
//     _scrollController.jumpTo(_pageController.page! * 85.0);
//   }
//
//   void onPageChanged(int index) {
//     setState(() {
...
//   }
//
//   void _onGridImageTap(int index) {
//     setState(() {
//       currentIndex = index;
...
//         crossAxisAlignment: CrossAxisAlignment.stretch,
//         children: [
//           // PhotoViewGallery for top images
//           Expanded(
//             child: PhotoViewGallery.builder(
//               itemCount: widget.imageUrls.length,
//               builder: (context, index) {
...
//
// class _ImageDetailScreenState extends State<ImageDetailScreen> {
//   late String tappedImageUrl;
//   int currentIndex = 0;
//
//   @override
//   void initState() {
//     super.initState();
//     tappedImageUrl = widget.selectedImageUrl;
//     currentIndex = widget.imageUrls.indexOf(tappedImageUrl);
//   }
//
//   @override
//   Widget build(BuildContext context) {
...
//         crossAxisAlignment: CrossAxisAlignment.stretch,
//         children: [
//           // PhotoView for top images
//           Expanded(
//             child: PhotoView(
//               imageProvider: NetworkImage(tappedImageUrl),
//               minScale: PhotoViewComputedScale.contained,
//               maxScale: PhotoViewComputedScale.covered * 2,
//               backgroundDecoration: BoxDecoration(
//                 color: Colors.white,
...
//                     onTap: () {
//                       setState(() {
//                         tappedImageUrl = widget.imageUrls[index];
//                         currentIndex = index;
//                       });
//                     },
//                     child: Container(
...
//             child: ImageGrid(imageUrls: widget.imageUrls),
//           ),
//         ],
//       ),
//     );
...
//             child: GestureDetector(
//               onTap: () {
//                 // Update the tappedImageUrl to display the selected image
//                 _ImageDetailScreenState screenState = context.findAncestorStateOfType<_ImageDetailScreenState>()!;
//                 screenState.setState(() {
//                   screenState.tappedImageUrl = imageUrls[index];
//                 });
//               },
//               child: Image.network(
//                 imageUrls[index],
